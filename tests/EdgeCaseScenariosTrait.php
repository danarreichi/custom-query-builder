...
/**
 * Shared test scenarios for EdgeCaseTest (mysqli) and SqliteEdgeCaseTest
 * (sqlite3) — every scenario here is driver-agnostic (real returned
 * data/exceptions, not exact compiled-SQL text). The handful of exact-SQL
 * assertions from the original EdgeCaseTest.php stay OUT of this trait and
 * are defined directly (once per driver) in each concrete class instead.
 *
